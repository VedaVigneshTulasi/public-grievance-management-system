    ...
    <div>
      ...
      <Card className="p-8 mb-8">
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            <h3 className="text-gray-500 text-sm">Complaint Title</h3>

            <p className="font-semibold text-lg mt-1">{complaint.title}</p>
          </div>

          <div>
            <h3 className="text-gray-500 text-sm">Department</h3>

            <p className="font-semibold text-lg mt-1">{complaint.department}</p>
          </div>

          <div>
            <h3 className="text-gray-500 text-sm">Priority</h3>

            <p className="font-semibold text-lg mt-1">{complaint.priority}</p>
          </div>
          ...
          <div>
            ...
            <p className="font-semibold text-lg mt-1">{complaint.location}</p>
          </div>

          <div>
            <h3 className="text-gray-500 text-sm">Created Date</h3>
        ...
        {complaint.remarks && complaint.remarks.length > 0 ? (
          <div className="space-y-6">
            {complaint.remarks.map((remark, index) => (
              <div key={index} className="border-l-4 border-[#0B2E59] pl-4">
