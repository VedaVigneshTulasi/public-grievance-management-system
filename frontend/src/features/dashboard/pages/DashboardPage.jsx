  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        <Card className="p-6">
          <h2 className="text-xl font-bold mb-6">Complaint Status Report</h2>

          <AnalyticsChart data={statusReport} type="bar" />
        </Card>

        <Card className="p-6">
          <h2 className="text-xl font-bold mb-6">Department Report</h2>

          <AnalyticsChart data={departmentReport} type="pie" />
        </Card>
      </div>
